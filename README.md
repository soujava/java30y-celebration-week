...
An event summary page. Modern, mobile-friendly, and fully static event site. All content is driven by JSON files for easy updates via pull request. No build step, no backend, no frameworks—just HTML, CSS (Tailwind via CDN), and vanilla JS.
